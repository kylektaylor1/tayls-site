<script lang="ts">
    import barcaImg from '$lib/assets/kyle-barca-low.jpg';
    import MailIcon from '$lib/components/icons/MailIcon.svelte';
    import XIcon from '$lib/components/icons/XIcon.svelte';
</script>

<div class="container flex flex-col gap-36 lg:flex-row">
    <div class="order-2 flex w-full flex-col gap-6 lg:order-1 lg:w-2/3">
        <h1 class="text-2xl font-semibold text-ctp-blue lg:text-3xl">
            I'm Kyle Taylor. A little about me...
        </h1>
        <div class="flex flex-col gap-4 text-sm text-ctp-text lg:text-base">
            <p>
    ...
    <div
        class="order-1 flex w-full flex-col items-center gap-8 lg:order-2 lg:w-1/3 lg:items-start"
    >
        <img
            src={barcaImg}
            alt="Kyle in Barcelona"
            class="max-h-[600px] w-4/5 rotate-2 rounded-2xl object-cover object-center lg:max-h-none lg:w-full"
        />
